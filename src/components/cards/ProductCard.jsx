...
<button className='inline  border-white rounded-full arrow_button'><Image src="/svg/arrow-right-solid.svg" className='invert' alt='arrow image'  width={18} height={18} /> </button>
        </div>
